...
catch(e){alert("Tu explorador no soporta este sitema, CasitaWeb te recomienda que uses Firefox (http://www.mozilla-europe.org/es/firefox/)");}return xmlhttp;}
...
function foco(elemento){elemento.style.border="1px solid #76C8FF";}function no_foco(elemento){elemento.style.border="1px solid #DAE8F8";}
