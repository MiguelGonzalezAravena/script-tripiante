<?php
global $forum_copyright, $forum_version, $webmaster_email, $slogan, $script_version;
...
$txt[30] = '';
$txt[31] = 'Eliminar';
$txt[33] = 'Agregar nuevo post';

$txt[34] = 'Ingresar';
$txt['login'] = 'Iniciar sesi&oacute;n';
$txt['invited_register_question'] = '&iquest;Todavia no estas registrado?';
$txt['invited_register_res'] = '&iexcl;Reg&iacute;strate Ahora!';
$txt[35] = 'Nick';
$txt[36] = 'Contrase&ntilde;a';

$txt[40] = 'Nombre de usuario no existente.';

$txt[62] = 'Moderador del Foro';
...
$txt[81] = 'Contrase&ntilde;a';
$txt[82] = 'Confirmar contrase&ntilde;a';
$txt[87] = 'Grupo';
...
$txt[125] = 'Notificar';
$txt[126] = '&#191;Deseas una notificaci&oacute;n por email si alguien responde a este tema?';
// Use numeric entities in the below string.
...
$txt[160] = 'Ir a';
$txt[161] = 'ir';
$txt[162] = '&#191;Est&aacute;s seguro de borrar este tema?';
$txt[163] = 'S&iacute;';
$txt[164] = 'No';
...
$txt[208] = 'Panel de Admin';
$txt[211] = '&Uacute;ltima modificaci&oacute;n';
$txt[212] = '&iquest;Deseas desactivar la notificaci&oacute;n en este tema?';

$txt[214] = $slogan;

$txt[227] = 'Ubicaci&oacute;n';
$txt[231] = 'Sexo';
$txt[233] = 'Fecha de registro';

$txt[234] = 'Ver los mensajes m&aacute;s recientes del foro.';
$txt[235] = 'es el tema actualizado m&aacute;s recientemente';
...
$txt['welcome_guest'] = 'Bienvenido(a), <b>' . $txt[28] . '</b>. Por favor, <a href="' . $scripturl . '?action=login">ingresa</a> o <a href="' . $scripturl . '?action=register">reg&iacute;strate</a>.';
...
$txt['sendtopic_this_topic'] = 'Quiero que revises el siguiente tema: %s, en ' . $context['forum_name'] . '. Para verlo, haz clic en el siguiente enlace';
...
$txt['sendtopic_comment'] = 'Hola! Te recomiendo que veas este post! 

Saludos!

' . $context['user']['name'];
$txt['sendtopic2_comment'] = 'Hola! Te recomiendo que veas esta imagen! 
...
// Use numeric entities in the below string.
$txt[1005] = 'SMF ha detectado errores en la base de datos, y los ha tratado de corregir autom&#225;ticamente.  Si los problemas persisten, o sigues obteniendo estos correos, por favor, contacta con tu proveedor de alojamiento web.';
...
$txt['online2'] = 'Conectado/a';
$txt['online3'] = 'Desconectado/a';
...
$txt['calendar37'] = 'Vincular al calendario';
...
$txt['who_title'] = 'Usuarios conectados';
$txt['who_and'] = ' y ';
...
$txt['ssi_not_direct'] = 'Por favor no accedas a SSI.php usando directamente el URL; mejor utiliza la ruta (%s) o agrega ?ssi_function=algun_valor.';
