...
function ManageNews() {
  ...
  if (allowedTo('send_mail'))
    $context['admin_tabs']['tabs'][] = array(
      ...
      'href' => $boardurl . '/noticias/correo-miembros/',
  ...
  if (allowedTo('admin_forum'))
    $context['admin_tabs']['tabs'][] = array(
      ...
      'href' => $boardurl . '/noticias/configuracion/',
...
function SendMailing()
{
  ...
  $_POST['message'] = str_replace($variables,
    array(
      ...
      !empty($_POST['send_html']) ? '<a href="' . $boardurl . '/perfil/' . $modSettings['latestRealName'] . '">' . $modSettings['latestRealName'] . '</a>' : $modSettings['latestRealName'],
  ...
  while ($row = mysqli_fetch_assoc($result))
  {
    ...
    $to_member = array(
      $row['emailAddress'],
      !empty($_POST['send_html']) ? '<a href="' . $boardurl . '/perfil/' . $row['realName'] . '">' . $row['realName'] . '</a>' : $boardurl . '/perfil/' . $row['realName'],
      $row['ID_MEMBER'],
      $row['realName']
    );
