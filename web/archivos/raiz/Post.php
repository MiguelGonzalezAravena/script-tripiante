...
$request = db_query("
SELECT m.ID_MEMBER, m.modifiedTime, m.smileysEnabled, m.body, m.posterName, m.posterEmail, m.subject, m.icon, m.hiddenOption, m.hiddenValue, m.ID_BOARD, t.ID_BOARD, t.ID_MEMBER_STARTED AS ID_MEMBER_POSTER, m.posterTime, t.ID_FIRST_MSG
FROM ({$db_prefix}messages AS m, {$db_prefix}topics AS t)
