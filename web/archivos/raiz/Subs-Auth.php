...
<html>
	<head>
		<title>Problemas de conexi&oacute;n</title>
	</head>
	<body>
		<h3>Problemas de conexi&oacute;n</h3>
		<span style="font-size:12px;">Lo sentimos, ', $mbname, ' no pudo conectarse a la base de datos. Esto puede ser causado por que el servidor est&aacute; ocupado. Por favor, int&eacute;ntelo de nuevo m&aacute;s tarde.</span>
	</body>
</html>';
