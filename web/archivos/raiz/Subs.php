...
{
	global $txt, $scripturl, $context, $modSettings, $user_info, $settings, $boardurl;
...
{
	global $txt, $context, $scripturl, $sc, $modSettings, $user_info, $settings, $boardurl;
...
$Array	=	mt_rand(1,2);
$request = mysql_query("SELECT value FROM {$db_prefix}settings WHERE variable = 'Highlights$Array'");
...
{
	global $db_prefix, $scripturl, $txt, $context, $ID_MEMBER, $modSettings, $boarddir, $boardurl, $settings, $db_connection;
...
} elseif(strlen($subject) < $modSettings['title_post_preview']) {
...
} elseif(strlen($_REQUEST['message']) < $modSettings['body_post_preview']) {
...
<div class="box_rss"><div class="icon_img"><a href="/rss/post-user/', $context['user']['name'], '"><img alt="" src="' . $settings['images_url'] . '/icons/tpbig-v1-iconos.gif?v3.2.3" style="cursor: pointer; margin-top: -352px; display: inline;"></a></div></div></div><div class="windowbg" style="padding: 4px; width: 130px;">
';
$userse = mysql_query("
SELECT *
FROM {$db_prefix}members
...
SELECT *
FROM {$db_prefix}membergroups
WHERE ID_GROUP = ".(!empty($idgrup2) ? $idgrup2 : $idgrup)."");
...
echo '<center><div class="fondoavatar" style="overflow:hidden;width:130px;" align="center"><a href="/perfil/' . $context['memberName'] . '" title="Ver Perfil">';
...
echo '<b><a href="/perfil/', $context['memberName'], '" style="font-size: 14px; color: rgb(255, 102, 0);">', $context['realName'], '</a></b><br />';
...
echo '<br><div style="margin-bottom: 2px;"><span style="font-size: 12px;"><img alt="" src="', $settings['images_url'], '/icons/mensaje_para.gif" border="0"> <a href="/mensajes/a/', $context['memberName'], '" title="Enviar mensaje">Enviar mensaje</a></span></div><div style="margin-bottom: 4px;"><span class="icons fot2" style="font-size: 12px;"><a href="/imagenes/', $context['memberName'], '" title="Sus im&aacute;genes"> Sus im&aacute;genes</a></span></div><br><hr class="divider">

			';
/* Se dirige hacia la Base de datos, y cuenta los comentarios del usuario */
$request = mysql_query("
SELECT *
