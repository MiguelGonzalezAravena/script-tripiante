...
function template_admin_above()
{
	...
	echo '<table width="100%" cellpadding="0" cellspacing="0" border="0" style="padding-top: 1ex;"><tr>
	...
	foreach ($context['admin_areas'] as $section)
	{
		...
		echo '<div style="width: 170px; float: left;"><div style="margin-bottom: 8px;" class="img_aletat"><div class="box_title" style="width: 158px;"><div class="box_txt img_aletat">', $section['title'], '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><div class="box_rss"><img alt="" src="', $settings['images_url'], '/blank.gif" style="width: 16px; height: 16px;" border="0"></div></div><div class="windowbg" style="padding: 4px; font-size: 13px; width: 150px;">
';
...
echo '<img src="', $settings['images_url'], '/icons/bullet-verde.gif">&nbsp;<font size="1">', $area, '</font><br />';
	...
	{
		echo '<div class="box_title" style="width:740px;"><div class="box_txt">';
		echo $context['admin_tabs']['title'];
		echo '</div></div>
		...
		if (!empty($settings['use_tabs']))
		{
			...
			foreach($context['admin_tabs']['tabs'] AS $tab)
				if (!empty($tab['is_selected']))
					$selected_tab = $tab;
			echo '<td class="smalltext" style="padding: 2ex;">', !empty($selected_tab['description']) ? $selected_tab['description'] : $context['admin_tabs']['description'], '</td>
					</tr>
				</table>';

			// The admin tabs.
			echo '<div style="float:left;width:750px;"><div class="mennes"><div class="botnes"><ul>
';
...
<a href="', $tab['href'], '" title="', $tab['title'], '">', $tab['title'], '</a>
			...
			// the end of tabs
			echo '</ul><div style="clear: both;"></div></div></div><div class="clearBoth"></div><br />';
		}
...
{
	global $context, $settings, $options, $scripturl, $txt, $modSettings, $script_version;

	// Welcome message for the admin.
	echo '<div class="box_757"><div class="box_title" style="width: 745px;"><div class="box_txt box_757-34"><center>', $txt[208], '</center></div><div class="box_rss"><img alt="" src="http://tripiante.net/images/blank.gif" style="width:16px;height:16px;" border="0"/></div></div><div style="width:737px;padding:4px;" class="windowbg">';
echo '<div align="center"><img src="/logos/logo.png" />';
echo '<hr style="width:50%;" />';
echo '<b>Administradores:</b>&nbsp;', implode(', ', $context['administrators']);
	if (!empty($context['more_admins_link']))
		echo '<br />(', $context['more_admins_link'], ')</div>';
