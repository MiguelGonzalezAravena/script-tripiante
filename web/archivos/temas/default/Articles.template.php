...
function template_articlesmain() {
  global $scripturl, $txt, $context, $settings, $boardurl, $db_prefix;

  // List all the catagories
  echo '
    <div class="box_buscador" style="margin-bottom: 8px;">
      <div class="box_title" style="width: 922px;">
        <div class="box_txt box_buscadort">' . $txt['smfarticles_indextitle'] . '</div>
        <div class="box_rss">
...
function template_articlelisting() {
      ...
      <tr>
        <td valign="top">
          <div class="box_buscador">
            <div class="box_title" style="width: 922px;">
              <div class="box_txt box_buscadort">' . $context['articles_cat_title'] . '</div>
                <div class="box_rss">
                  <img alt="" src="' . $settings['images_url'] . '/espacio.gif" style="width: 14px; height: 12px;" border="0" />
                </div>
              </div>
  ...
  foreach ($context['articles_listing'] as $row) {
    echo '
      <img alt="" src="' . $settings['images_url']  .'/ayuda/articulo.png" title="' . $row['title'] . '" />
      &nbsp;
      <a href="' . $boardurl . '/ayuda/articulo/' . $row['ID_ARTICLE'] . '">' . $row['title'] . '</a>';
  ...
  if ($context['addarticle']) {
    echo '
      <a href="' . $scripturl . '?action=articles;sa=addarticle;cat=' . $context['articles_cat_id'] . '">' . $txt['smfarticles_addarticle'] . '</a>
      &nbsp;
      <br /><br />';
  }
}
...
function template_viewarticle() {
  global $txt, $context, $settings, $ID_MEMBER;
            ...
            <div class="box_buscador">
              <div class="box_title" style="width: 922px;">
                <div class="box_txt box_buscadort">
                  <center>' . $context['article']['title'] . '</center>
                </div>
                <div class="box_rss"> 
                  <img alt="" src="' . $settings['images_url'] . '/espacio.gif" style="width: 14px; height: 12px;" border="0" />
                </div>
...
function template_addcat() {
  ...
  echo '
    <center>
      <div class="box_title" style="width: 539px;">
        <div class="box_txt">' . $txt['smfarticles_addcat'] . '</div>
        <div class="box_rss">
      ...
      <div class="windowbg" style="width: 531px; padding: 4px;">
        <form style="margin: 0px; padding: 0px;" action="' . $scripturl . '?action=articles;sa=addcat2"" method="POST" name="cateform" accept-charset="' . $context['character_set'] . '">
          <table>
            <tr>
              <td style="width: 100px;">
                <b>' . $txt['smfarticles_ctitle'] . '</b>
              </td>
              <td>
                <input type="text" name="title" size="64" maxlenght="100" onfocus="foco(this);" onblur="no_foco(this);" style="width:300px;" />
              </td>
            </tr>
            <tr>
              <td style="width:100px;">
                <b>' . $txt['smfarticles_parentcategory'] . '</b>
              </td>
              <td>
                <select name="parent">
  ...
  echo '
        ...
        <p align="right" style="padding: 0px; margin: 0px;">
          <input type="submit" class="login" value="' . $txt['smfarticles_addcat'] . '" name="submit" />
        </p>
      </form>
    </center>';
}
...
function template_editcat() {
  ...
  echo '
    <center>
      <div class="box_title" style="width: 539px;">
        <div class="box_txt">' . $txt['smfarticles_editcat'] . '</div>
        <div class="box_rss">
          <img alt="" src="' . $settings['images_url'] . '/blank.gif" style="width: 14px; height: 12px;" border="0">
        </div>
      </div>
      <div class="windowbg" style="width: 531px; padding: 4px;">
        <form style="margin: 0px; padding: 0px;" action="' . $scripturl . '?action=articles;sa=editcat2" method="POST" name="catform" accept-charset="' . $context['character_set'] . '">
          <table>
            <tr>
              <td style="width: 100px;">
                <b>' . $txt['smfarticles_ctitle'] . '</b>
              ...
              <td>
                <input value="' . $context['articles_data']['title'] . '" type="text" name="title" onfocus="foco(this);" onblur="no_foco(this);" style="width: 300px;" size="64" maxlength="100"/>
              </td>
            </tr>
            <tr>
              <td style="width: 100px;">
  ...
  echo '
        ...
        <p align="right" style="padding: 0px; margin: 0px;">
          <input type="submit" class="login" value="' . $txt['smfarticles_editcat'] . '" name="submit" />
        </p>
      </form>
    </center>';
}
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="100%">
          ...
          <tr>
            <td width="28%" colspan="2" align="center" class="windowbg2">
              ...
              <input type="submit" value="' . $txt['smfarticles_deltcat'] . '" name="submit" />
            </td>
          </tr>
        </table>
      </form>
...
function template_addarticle() {
  ...
  echo '
    <form method="post" enctype="multipart/form-data" action="' . $scripturl . '?action=articles;sa=addarticle2" name="addarticle" id="addarticle">
      <table cellpadding="0" cellspacing="0" class="tborder" width="100%">
        <tr>
          <td width="50%" colspan="2" align="center" class="catbg">
            <b>' . $txt['smfarticles_addarticle'] . '</b>
          </td>
        </tr>
        <tr>
  ...
  echo '
    ...
    <tr>
      <td width="28%" valign="top" class="windowbg2" align="right">
        <span class="gen">
          <b>' . $txt['smfarticles_summary'] . '</b>
        </span>
      </td>
      <td width="72%" class="windowbg2">
        <textarea style="height: 300px; width: 615px;" onfocus="foco(this);" onblur="no_foco(this);" id="markItUp" name="description" class="markItUpEditor"></textarea>
      </td>
    </tr>
    <tr>
    ...
    echo '
      <tr class="windowbg2">
        <td valign="top" align="right">
          <b>' . $txt['smfarticles_txt_upload_image'] . '</b>
        </td>
        <td>
          <input type="file" size="75" name="uploadimage" />
          <br /><br />
        </td>
      </tr>';
  }
  ...
  if ($context['show_spellchecking']) {
    echo '<input type="button" value="' . $txt['spell_check'] . '" tabindex="' . $context['tabindex']++ . '" onclick="spellCheck(\'addarticle\', \'message\');" />';
  }

  echo '
            <input type="submit" value="' . $txt['smfarticles_addarticle'] . '" name="submit" />
          </td>
        </tr>
      </table>
    </form>';
...
function template_editarticle() {
    ...
    <div class="tborder">
      <form method="post" enctype="multipart/form-data" action="' . $scripturl . '?action=articles;sa=editarticle2" name="editarticle" id="editarticle">
        <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="100%">
          <tr>
            <td width="50%" colspan="2" align="center" class="catbg">
              <b>' . $txt['smfarticles_editarticle'] . '</b>
            </td>
          </tr>
          <tr>
            <td width="28%" class="windowbg2" align="right">
            ...
            <td width="72%" class="windowbg2">
              <input type="text" name="title" size="64" maxlength="100" value="' . $context['article_data']['title'] . '" />
            </td>
          </tr>
          <tr>
            <td width="28%" class="windowbg2" align="right">
  ...
  echo '
    ...
    <tr>
      ...
      <td width="72%" class="windowbg2">
        <textarea rows="6" name="description" cols="54">' . $context['article_data']['description'] . '</textarea>
      </td>
    </tr>
    <tr>
      <td class="windowbg2" colspan="2" align="center">
  ...
  if ($context['show_spellchecking']) {
    echo '<input type="button" value="' . $txt['spell_check'] . '" tabindex="' . $context['tabindex']++ . '" onclick="spellCheck(\'editarticle\', \'message\');" />';
  }

  echo '
            <input type="hidden" value="' . $context['article_id'] . '" name="id" />
            <input type="submit" value="' . $txt['smfarticles_editarticle'] . '" name="submit" />
          </td>
        </tr>
      </table>
      </form>
...
function template_deletearticle() {
  ...
  echo '
    <div class="tborder">
      <form method="post" action="' . $scripturl . '?action=articles;sa=deletearticle2">
        <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="100%">
          <tr>
            <td width="50%" colspan="2" align="center" class="catbg">
              <b>' . $txt['smfarticles_delarticle'] . '</b>
            </td>
          </tr>
          <tr>
            <td width="28%" colspan="2"  align="center" class="windowbg2">
              ...
              <br />
              <input type="hidden" value="' . $context['article_id'] . '" name="id" />
              <input type="submit" value="' . $txt['smfarticles_delarticle'] . '" name="submit" />
            </td>
          </tr>
        </table>
      </form>
      ...
      <tr class="windowbg">
        <td class="windowbg">
          <table  class="bordercolor" cellpadding="0" cellspacing="0" width="100%">
            ...
            <td class="catbg">
              <b>' . $txt['smfarticles_submittedby'] . '</b>
            </td>
            <td class="catbg">
              <b>' . $txt['smfarticles_options'] . '</b>
            </td>
            </tr>';
  ...
  echo '
    <table border="0" width="80%" cellspacing="0" align="center" cellpadding="4" class="tborder">
      ...
      <tr class="windowbg">
        <td class="windowbg">
          <br />
          <b>' . $txt['smfarticles_articlesconfig'] . '</b>
          <br />
          <form method="post" action="' . $scripturl . '?action=articles;sa=admin2">
            ' . $txt['smfarticles_setarticlessperpage'] . '
            &nbsp;
            <input type="text" name="smfarticles_setarticlesperpage" value="' .  $modSettings['smfarticles_setarticlesperpage'] . '" />
            <br />
            <input type="checkbox" name="smfarticles_countsubcats" ' . ($modSettings['smfarticles_countsubcats'] ? ' checked="checked" ' : '') . ' />
            &nbsp;
            ' . $txt['smfarticles_countsubcats'] . '
            <br />
            <b>' . $txt['smfarticles_listingdisplay'] . '</b>
            <br />
            <input type="checkbox" name="smfarticles_disp_views" ' . ($modSettings['smfarticles_disp_views'] ? ' checked="checked" ' : '') . ' />
            &nbsp;' . $txt['smfarticles_disp_views'] . '
            <br />
            <input type="checkbox" name="smfarticles_disp_membername" ' . ($modSettings['smfarticles_disp_membername'] ? ' checked="checked" ' : '') . ' />
            &nbsp;
            ' . $txt['smfarticles_disp_membername'] . '
            <br />
            <input type="checkbox" name="smfarticles_disp_date" ' . ($modSettings['smfarticles_disp_date'] ? ' checked="checked" ' : '') . ' />&nbsp;
            ' . $txt['smfarticles_disp_date'] . '
            <br /><br /><br />
...
function template_catperm() {
  ...
  echo '
            ...
            <tr class="windowbg2">
              ...
              <td>
                <b>' . $txt['smfarticles_perm_delete'] . '</b>
              </td>
            </tr>
            <tr class="windowbg2">
              <td align="center" colspan="2">
                <input type="hidden" name="cat" value="' . $context['articles_cat'] . '" />
                <input type="submit" value="' . $txt['smfarticles_text_addperm'] . '" />
              </td>
            </tr>
          </table>
        </form>
  ...
  foreach($context['articles_membergroup'] as $row) {
    echo '
      <tr class="windowbg2">
        ...
        <td>
          <a href="' . $scripturl . '?action=articles;sa=catpermdelete&id=' . $row['ID'] . '">' . $txt['smfarticles_txtdel'] . '</a>
        </td>
      </tr>';
  }
  ...
  foreach ($context['articles_mbgroups'] as $row) {
    echo '
      <tr class="windowbg2">
        <td>' . $row['groupName'] . '</td>
        <td>
          <a href="' . $scripturl . '?action=articles;sa=catperm;cat=' . $row['ID_CAT'] . '">' . $row['catname'] . '</a>
        </td>
        <td>' . ($row['view'] ? $txt['smfarticles_perm_allowed'] : $txt['smfarticles_perm_denied']) . '</td>
        <td>' . ($row['addarticle'] ? $txt['smfarticles_perm_allowed'] : $txt['smfarticles_perm_denied']) . '</td>
        <td>' . ($row['editarticle'] ? $txt['smfarticles_perm_allowed'] : $txt['smfarticles_perm_denied']) . '</td>
...
function template_myarticles() {
  ...
  echo '
    ...
    <table cellspacing="0" cellpadding="10" border="0" align="center" width="90%" class="tborder">
      <tr>
        <td class="titlebg">
          <a href="' . $scripturl . '?action=articles;sa=myarticles;start=' . $context['start'] . ';sort=title;sorto=' . $context['articles_newsorto'] . '">' . $txt['smfarticles_ctitle'] . '</a>
        </td>';

  if (!empty($modSettings['smfarticles_disp_rating'])) {
    echo '
      <td class="titlebg">
        <a href="' . $scripturl . '?action=articles;sa=myarticles;start=' . $context['start'] . ';sort=rating;sorto=' . $context['articles_newsorto'] . '">' . $txt['smfarticles_crating'] . '</a>
      </td>';
  }
  ...
  if (!empty($modSettings['smfarticles_disp_totalcomment'])) {
    echo '
      <td class="titlebg">
        <a href="' . $scripturl . '?action=articles;sa=myarticles;start=' . $context['start'] . ';sort=comment;sorto=' . $context['articles_newsorto'] . '">' . $txt['smfarticles_txt_comments'] . '</a>
      </td>';
  }
  ...
  if (!empty($modSettings['smfarticles_disp_views'])) {
    echo '
      <td class="titlebg">
        <a href="' . $scripturl . '?action=articles;sa=myarticles;start=' . $context['start'] . ';sort=views;sorto=' . $context['articles_newsorto'] . '">' . $txt['smfarticles_cviews'] . '</a>
      </td>';
  }
  ...
  if (!empty($modSettings['smfarticles_disp_membername'])) {
    echo '
      <td class="titlebg">
        <a href="' . $scripturl . '?action=articles;sa=myarticles;start=' . $context['start'] . ';sort=username;sorto=' . $context['articles_newsorto'] . '">' . $txt['smfarticles_cusername'] . '</a>
      </td>';
  }
  ...
  if (!empty($modSettings['smfarticles_disp_date'])) {
    echo '
      <td class="titlebg">
        <a href="' . $scripturl . '?action=articles;sa=myarticles;start=' . $context['start'] . ';sort=date;sorto=' . $context['articles_newsorto'] . '">' . $txt['smfarticles_cdate'] . '</a>
      </td>';
  }
  ...
  foreach ($context['articles_listing'] as $row) {
    echo '
      <tr  class="' . $styleclass  . '">
        <td>
          <a href="' . $scripturl . '?action=articles;sa=view;article=' . $row['ID_ARTICLE'] . '">' . $row['title'] . '</a>
        </td>';
  ...
  if ($addarticle) {
    echo '
      <a href="' . $scripturl . '?action=articles;sa=addarticle">' . $txt['smfarticles_addarticle'] . '</a>
      &nbsp;
      <br /><br />';
  }
...
function template_search() {
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="90%"  class="tborder" align="center">
        <tr>
          <td width="100%" colspan="2" align="center" class="catbg">
            <b>' . $txt['smfarticles_search_article'] . '</b>
          </td>
        </tr>
        <tr class="windowbg2">
          <td width="50%"  align="right">
            <b>' . $txt['smfarticles_search_for'] . '</b>
            &nbsp;
          </td>
          <td width="50%">
        ...
        <tr class="windowbg2" align="center">
          <td colspan="2">
            ...
            ' . $txt['smfarticles_search_title'] . '
            &nbsp;
            <input type="checkbox" name="searchdescription" checked="checked" />
            ' . $txt['smfarticles_search_description'] . '
            &nbsp;
          </td>
        </tr>
        <tr class="windowbg2">
          <td colspan="2" align="center">
            <hr />
            <b>' . $txt['smfarticles_search_advsearch'] . '</b>
            <br />
            <hr />
          </td>
        </tr>
  ...
  echo '
        ...
        <tr class="windowbg2">
          <td width="30%" align="right">
            ' . $txt['smfarticles_search_daterange'] . '
            &nbsp;
          </td>
          <td width="70%">
        ...
        <tr class="windowbg2">
          <td width="30%"  align="right">
            ' . $txt['smfarticles_search_membername'] . '
            &nbsp;
          </td>
          <td width="70%">
            <input type="text" name="pic_postername" id="pic_postername" value="" />
            <a href="' . $scripturl . '?action=findmember;input=pic_postername;quote=1;sesc=' . $context['session_id'] . '" onclick="return reqWin(this.href, 350, 400);">
              <img src="' . $settings['images_url'] . '/icons/assist.gif" alt="' . $txt['find_members'] . '" />
            </a> 
...
function template_search_results() {
  ...
  echo '
    <tr class="titlebg">
      <td align="center" colspan="' . $spancount . '">';
