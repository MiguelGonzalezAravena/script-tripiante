    ...
    <div>
      <div class="box_buscador">
        <div class="box_title" style="width: 920px;">
          <div class="box_txt box_buscadort">' . $txt['chat']  . '</div>
          <div class="box_rss">
        ...
        <div style="width: 912px; padding: 4px;" class="windowbg" border="0">
          ...
          <iframe src="https://xat.com/embed/chat.php#id=' . $chatid . '" width="100%" height="500" frameborder="0" scrolling="no"></iframe>
          <br /><br />
        </div>
      </div>
      <div class="box_buscador">
        <div class="box_title" style="width: 920px;">
          <div class="box_txt box_buscadort">' . $txt['aclaracion'] . '</div>
          <div class="box_rss">
            <img alt="" src="' . $settings['images_url'] . '/blank.gif" style="width: 14px; height: 12px;" border="0" />
          </div>
        </div>
        <div style="width: 912px; padding: 4px; text-align: left;" class="windowbg" border="0">
          <font class="size12">' . $txt['rules'] . '</font>
        </div>
      </div>';
}
