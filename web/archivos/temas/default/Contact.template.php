...
{
	global $context, $webmaster_email, $userinfo, $context, $scripturl, $modSettings, $txt, $settings;
	...
	}</script><div><form action="/contactanos/enviando/" method="post" accept-charset="UTF-8"><div class="box_buscador">
<div class="box_title" style="width: 920px;"><div class="box_txt box_buscadort"><center>Contacto</center></div>
<div class="box_rss"><img alt="" src="', $settings['images_url'] ,'/blank.gif" style="width: 14px; height: 12px;" border="0" /></div></div><div class="windowbg" style="width:912px;padding:4px;"><center>
			...
			<br />
			<textarea onfocus="foco(this);" onblur="no_foco(this);" name="comentario" style="width:249px;" cols="40" rows="5" tabindex="7"></textarea><label id="comentario"></label><br /><b class="size11">* C&oacute;digo de la im&aacute;gen</b><br /><script type="text/javascript">var RecaptchaOptions = {theme : \'', empty($modSettings['recaptcha_theme']) ? 'clean' : $modSettings['recaptcha_theme'] , '\',};</script><script type="text/javascript" src="http://api.recaptcha.net/challenge?k=', $modSettings['recaptcha_public_key'], '"></script><noscript><iframe src="http://api.recaptcha.net/noscript?k=', $modSettings['recaptcha_public_key'], '" frameborder="0"></iframe><br /><textarea name="recaptcha_challenge_field" rows="2" cols="10"></textarea><input type="hidden" name="recaptcha_response_field" value="manual_challenge" /></noscript><label id="visual_verification_code"></label><br /><font class="size11" style="color: red;">* Campos obligatorios</font><br />
...
</center></div></div></form></div><div style="clear:both"></div>';
//--------------------------------------------------------------------------------------------------
//		Visual verification
//--------------------------------------------------------------------------------------------------
	if ($context['visual_verification'] || isset($context['contact_form_error_visual_verification']))
	{
		echo '
			<table class="normaltext">
				<tr>
					<td';
		if (isset($context['contact_form_error_visual_verification'])) echo ' style="border-style: solid; border-color: red; border-width: 2px;"';
		echo '>
			...
			'</td>
					<td>';
		if (isset($context['contact_form_error_visual_verification'])) echo '<span class="smalltext" style="color: red;">', $context['visual_verification_error_dscr'], '</span>';
		echo '</td>
				</tr>
			</table>';
	}
