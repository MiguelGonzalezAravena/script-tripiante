...
{
fatal_error('Disculpe, para denunciar a un usuario debes autentificarte.-', false);
}
elseif(empty($_GET['id']))
{
fatal_error('Debes ingresar el usuario a denunciar.-', false);
}
elseif($context['NOMBRE_USER'] != $memberName)
{
fatal_error('El usuario que deseas denunciar no existe.-', false);
}
elseif($context['NOMBRE_USER'] == $context['user']['name'])
{
fatal_error('Disculpe, pero no puedes denunciarte a ti mismo.-', false);
}
else
{
...
echo '<form action="/denuncia/enviar/" method="post" accept-charset="', $context['character_set'], '"><div ><div class="box_buscador"><div class="box_title" style="width:921px;"><div class="box_txt box_buscadort"><center>Denunciar Usuario</center></div><div class="box_rss"><img alt="" src="http://casitaweb.net/images/blank.gif" style="width:14px;height:12px;" border="0" /></div></div><div class="windowbg" style="width:919px;"><center>
<p align="center" style="margin:0px;padding:0px;" class="size11"><br/><b>Denunciar al usuario:</b><br />', $memberName, '<br /><br /><font class="size11"><b>Raz&oacute;n de la denuncia:</b></font><br />
			...
			<textarea name="comentario" cols="40" rows="5" wrap="hard" tabindex="6"></textarea><label id="errorss"></label>
<br /><br /><input onclick="return errorrojos(this.form.comentario.value);" class="login" type="submit" value="Denunciar Usuario" /><br /><input type="hidden" name="ID_TOPIC" value="', $ID_MEMBER, '" />
<input type="hidden" name="tipo" value="user" /><br /></center></div></div></div></form><div style="clear:both"></div>'; 
