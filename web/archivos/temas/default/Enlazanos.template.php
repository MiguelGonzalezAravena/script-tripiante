          ...
          <table style="border-bottom:1px solid #B3A496;">
            <tr>
              ...
              <td style="width: 772px; height: 62px;">
                <textarea readonly="readonly" onmouseup="this.focus(); this.select()" wrap="off" style="border: 1px dashed rgb(192, 192, 192); background-color: rgb(249, 249, 249); width: 772px; height: 50px; font-family: Courier New; font-size: 10px;">&lt;a title="' . $mbname . '" href="' . $boardurl . '/"&gt;
&nbsp;&nbsp;&lt;img src="' . $boardurl . '/web/enlazanos/16x16.gif" alt="' . $mbname . '" width="16" border="0" height="16" /&gt;
&lt;/a&gt;</textarea>
              </td>
            </tr>
