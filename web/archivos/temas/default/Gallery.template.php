...
function template_main()
{
	...
	$us = htmlentities(addslashes($_REQUEST['user']));
	if(empty($us)){
...
if($PagAct>1) echo '<a href=\'/imagenes/'.$_GET['user'].'/pag-' . $PagAnt . '\'>&#171; anterior</a>';
if($PagAct<$PagUlt)  echo '<a href=\'/imagenes/'.$_GET['user'].'/pag-' . $PagSig . '\'>siguiente &#187;</a>';

echo '
</div><div class="clearBoth"></div><div style="clear: both;"></div></div><div style="clear:both"></div>';
}
else
{
$RegistrosAMostrar		=	9;
...
ORDER BY g.ID_PICTURE DESC
LIMIT {$RegistrosAEmpezar}, {$RegistrosAMostrar}", __FILE__, __LINE__);
echo '<style type="text/css">.photo_small{width:90px;margin:6px;padding:2px;text-align:left;background:#FFFFFF none repeat scroll 0%;border:1px solid #000000;}</style><div class="box_buscador">
...
echo '</div>';
echo '<div class="clearBoth"></div><div style="clear: both;"></div></div><div style="clear:both"></div>';
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
 ...
 echo '</select>
  ...
  <tr class="windowbg2">
	  ...
	  <td><textarea name="description" rows="6" cols="55">' . $context['gallery_pic']['description'] . '</textarea>';
...
echo '
  ...
  <tr class="windowbg2">
	  ...
	  <td><input type="text" name="keywords" maxlength="100" value="' . $context['gallery_pic']['keywords'] . '" /></td>
  </tr>
  <tr class="windowbg2">
...
{
	global $scripturl, $context, $txt, $ID_MEMBER, $modSettings, $memberContext, $db_prefix, $settings, $boardurl, $options;
...
document.getElementById(\'errors\').innerHTML=\'<font class="size10" style="color: red;">Es necesaria la causa de la eliminaci&oacute;n.</font>\'; return false;}}
...
/* Aqu&#237; puedes empezar a modificar el Dise&#241;o de la imagen */
...
echo '<div class="box_rss"><div class="icon_img"><a href="/rss/post-user/', $context['memberName'], '"><img alt="" src="', $settings['images_url']. '/icons/tpbig-v1-iconos.gif?v3.2.3" style="cursor:pointer;margin-top:-352px;display:inline;" /></a></div></div></div><div class="windowbg" style="width: 130px; padding: 4px;">
<center>';
	
if ($context['avatar']){
echo '<div class="fondoavatar" style="overflow:hidden;width:130px;" align="center"><a href="/perfil/', $context['memberName'], '" title="Ver Perfil"><img src="'.$context['avatar'].'" width="105" alt="" class="avatar" border="0" onerror="error_avatar(this)" /></a><br /><span class="mp">', $context['personalText'], '</span></div></center><br/>';
}
else
{
echo '<div class="fondoavatar" style="overflow: auto; width: 130px;" align="center"><a href="/perfil/', $context['memberName'], '" title="Ver Perfil"><img src="', $boardurl, '/avatar.gif" alt="Sin Avatar" border="0"></a><br><span class="mp">', $context['personalText'], '</span></div></center><br>';
}
	echo '<b><a href="/perfil/', $context['memberName'], '" style="font-size:14px;color:#FF6600;">', $context['realName'], '</a></b><br />';

			echo '<b style="font-size:12px;color:#747474;text-shadow: #6A5645 0px 1px 1px;">', (!empty($membergropu2) ? $membergropu2 : $membergropu), '</b><br />';
		...
		if ($settings['show_profile_buttons'])
		{
			...
			{
			echo '<div style="margin-bottom:2px;"><span style="font-size:12px;"><img alt="" src="' . $settings['images_url'] . '/icons/mensaje_para.gif" border="0" /> <a href="/mensajes/a/', $context['memberName'], '" title="Enviar mensaje">Enviar mensaje</a></span></div>';
			echo '<div style="margin-bottom:4px;"><span class="icons fot2" style="font-size:12px;"><a href="/imagenes/', $context['memberName'], '" title="Sus im&aacute;genes"> Sus im&aacute;genes</a></span></div>';
			}
		}
...
<b style="color:#FE8F47;text-shadow: #6A5645 0px 1px 1px;">COMENTARIOS:</b> <b><a href="/user-comment/', $context['memberName'], '">', $context['comentuser'], '</a></b></div><br />';
if ($context['user']['is_guest'])					
{
echo '<div class="hrs"></div><div class="size11"><br><a href="/registrarse/" target="_blank" rel="nofollow">&iexcl;REG&Iacute;STRATE!</a> es <b>GRATIS</b></div>';
}
echo '<span class="size11"></span></div></div>';

echo '<div class="box_780" style="float:left;">
<div class="box_title" style="width: 772px;"><div class="box_txt box_780-34"><center>' . $context['gallery_pic']['title'] . '</center></div><div class="box_rss"><div class="icon_img"><a href="/imprimir/imagen/' . $context['gallery_pic']['ID_PICTURE'] . '"><img alt="" src="', $settings['images_url'], '/icons/tpbig-v1-iconos.gif?v3.2.3" style="cursor:pointer;margin-top:-640px;display:inline;" /></a></div></div></div><div class="windowbg" style="width:772px;" id="img_' . $context['gallery_pic']['ID_PICTURE'] . '">
...
echo '<center><img onload="if(this.width > 750) {this.width=750}" alt="" title="' . $context['gallery_pic']['title'] . '"  src="' . $context['gallery_pic']['filename']  . '" /></center>';
if($context['user']['is_guest'])
{
...
echo '<!-- info de la imagen --><div style="width:780px;margin-top:8px;"><div style="width:380px;float:left;margin-right:8px;#margin-right:8px;_margin-right:6px;">
<div class="box_390" style="width:380px;">

<div class="box_title" style="width:378px;"><div class="box_txt box_390-34">Opciones</div>
<div class="box_rss"><span id="cargando_opciones" style="display:none;"><img alt="" src="' . $settings['images_url'] . '/icons/cargando.gif" style="width:16px;height:16px;" border="0" /></span><span id="cargando_opciones2"><img alt="" src="' . $settings['images_url'] . '/blank.gif" style="width:16px;height:16px;" border="0" /></span></div></div><div class="windowbg size11" style="width:370px;padding:4px;">';
if($context['user']['is_logged'])
{
echo '<form action="/eliminar-imagen/' . $context['gallery_pic']['ID_PICTURE'] . '/" method="post" accept-charset="', $context['character_set'], '" style="margin:0px;padding:0px;" name="causa" id="causa">';
}
if($context['allow_admin']) {
echo '<input class="login" style="font-size: 11px;" value="Editar img" title="Editar img" onclick="location.href=\'/editar-imagen/id-' . $context['gallery_pic']['ID_PICTURE']  . '\'; return errorrojo2(this.form.causa.value);" type="button"> <input class="login" style="font-size: 11px;" value="Eliminar img" title="Eliminar img" onclick="if (!confirm(\'\xbfEstas seguro que desea eliminar esta imagen?\')) return false; return errorrojo2(this.form.causa.value);" type="submit"> <input type="text" id="causa" name="causa" maxlength="50" size="30"><center><label id="errors"></label></center><div class="hrs"></div>';
} elseif($iduser==$context['user']['id'] || $context['allow_admin']){
echo '<input class="login" style="font-size: 11px;" value="Editar img" title="Editar img" onclick="location.href=\'/editar-imagen/id-' . $context['gallery_pic']['ID_PICTURE']  . '\'" type="button"> <input class="login" style="font-size: 11px;" value="Eliminar img" title="Eliminar img" onclick="if (!confirm(\'\xbfEstas seguro que desea eliminar esta imagen?\')) return false; location.href=\'/eliminar-img/', $context['current_topic'], '/\'" type="button"><div class="hrs"></div>';
}
...
for($o = 1; $o <= $puntos;$o++) {
echo '<a href="#" onclick="votar_img(\'' . $context['gallery_pic']['ID_PICTURE'] . '\',\''.$o.'\'); return false;" title="Dar '.$o.' puntos">'.$o.'</a>'; $contarpuntos++;
...
if($context['user']['is_logged']) {
echo '<center><span id="span_opciones2" style="text-align: center; display: block;"><a class="icons agregar_favoritos"  href="#" onclick="add_favoritos_img(\'' . $context['gallery_pic']['ID_PICTURE'] . '\'); return false;" >Agregar a Favoritos</a> | <a class="icons denunciar_post" title="Denunciar Imagen" href="/denuncia/imagen-' . $context['gallery_pic']['ID_PICTURE'] . '"/>Denunciar Imagen</a> | <a class="icons recomendar_post" href="/enviar-a-amigo/imagen-' . $context['gallery_pic']['ID_PICTURE'] . '">Enviar a un amigo</a></span></center>';
} else {
echo '<a class="icons recomendar_post" href="/enviar-a-amigo/imagen-' . $context['gallery_pic']['ID_PICTURE'] . '">Enviar a un amigo</a>';
}

echo '<div class="hrs"></div><b class="size13">Otras imagenes:</b><br />';
foreach($context['al-azar'] AS $alzar) {
echo '<div class="entry_item"><div class="icon"><img alt="" title="'.$alzar['title'].'" src="' . $settings['images_url'] . '/icons/foto.gif" /></div><div class="text_container">
<a rel="dc:relation" href="/imagenes/ver/'.$alzar['ID_PICTURE'].'" title="'.$alzar['title'].'" target="_self" >'.$alzar['title'].'</a>
</div></div>
';
}
...
<b>Creado el:</b>&nbsp;<span property="dc:date" content="' . $fecha . '">' . $fecha . '</span><div class="hrs"></div><div style="float:left; margin-right:4px;"><b>Agregar a:</b></div>
...
<div class="icon_img" style="float: left; margin-right:4px;"><a href="http://twitter.com/home?status=Les recomiendo que vean esta imagen: ' . $link . '" rel="nofollow" target="_blank" title="Agregar a: Twitter"><img alt="" src="' . $settings['images_url'] . '/icons/tpbig-v1-iconos.gif?v3.2.3" style="cursor:pointer;margin-top:-472px;display:inline;" /></a></div>
...
<div class="icon_img"><a href="http://digg.com/submit?phase=2&#38;url=' . $link . '" rel="nofollow" target="_blank" title="Agregar a: Digg"><img alt="" src="' . $settings['images_url'] . '/icons/tpbig-v1-iconos.gif?v3.2.3" style="cursor:pointer; margin-top:-453px;display:inline;" /></a></div><hr /><table>
<tr><td width="50px"><b>Enlace:</b></td><td width="290px"><input id="enlace" name="enlace" type="text" onfocus="foco(this);" onblur="no_foco(this);" value="' . $context['gallery_pic']['filename']  . '" onclick="selectycopy(getElementById(\'enlace\')); APITrack(\'copy_details_url\');" style="width:290px;"></td></tr>

<tr><td width="50px"><b>Embed:</b></td><td width="290px"><input id="embed" name="embed" type="text" onfocus="foco(this);" onblur="no_foco(this);" value="&lt;a title=&quot;' . $context['gallery_pic']['title']  . ' - ' . $boardurl . '&quot; href=&quot;' . $link . '&quot; target=&quot;_blank&quot;&gt;' . $context['gallery_pic']['title']  . ' - ' . $boardurl . '&lt;/a&gt;" onclick="selectycopy(getElementById(\'embed\')); APITrack(\'copy_details_url\');" style="width:290px;"></td></tr>

<tr><td width="50px"><b>BBCode:</b></td><td width="290px"><input id="bbcode" name="bbcode" type="text" onfocus="foco(this);" onblur="no_foco(this);" value="[IMG]' . $context['gallery_pic']['filename']  . '[/IMG]" onclick="selectycopy(getElementById(\'bbcode\')); APITrack(\'copy_details_url\');" style="width:290px;"></td></tr>
</table></div></div>';
...
echo '<form action="/comentario-img/eliminar/" method="post" accept-charset="', $context['character_set'], '" id="eliminar-comments">';
}
...
echo '<div id="cmt_'.$pic_comment['ID_COMMENT'].'"><span class="size12">';
if($context['allow_admin'] || $iduser == $context['user']['id']) {
echo '<input type="checkbox" name="campos['.$pic_comment['ID_COMMENT'].']" />';
}

echo ' <a onclick="citar_comment('.$pic_comment['ID_COMMENT'].')" href="javascript:void(0)">#'.$cantidad++.'</a> <b id="autor_cmnt_'.$pic_comment['ID_COMMENT'].'" user_comment="'.$pic_comment['memberName'].'" text_comment=\''.$pic_comment['comment2'].'\'><a href="/perfil/'.$pic_comment['memberName'].'">'.$pic_comment['realName'].'</a></b> | 
<span class="size10">' . date("d.n.y H:i:s", $pic_comment['date']) . '</span>';
if($context['user']['is_logged']) {
echo ' <a  href="/mensajes/a/'.$pic_comment['memberName'].'" title="Enviar MP a: '.$pic_comment['realName'].'"><img alt="" src="' . $settings['images_url'] . '/icons/mensaje_para.gif" style="margin-top:2px;margin-rigth:2px;" align="top" border="0" /></a><a class="icons citar" onclick="citar_comment('.$pic_comment['ID_COMMENT'].')" href="javascript:void(0)" title="Citar Comentario"><img alt="" src="' . $settings['images_url'] . '/espacio.gif" align="top" border="0" /></a>';
}
echo 'dijo:<br /><div style="overflow: hidden;">'. $pic_comment['comment'] .'</div></span></div><div class="hrs"></div>';
}
} else {
...
echo '<input value="'.$context['id_img'].'" name="idimg" id="idimg" type="hidden"></form></div></div>
<!-- fin comentarios -->';
...
<input class="login" type="button" id="button_add_comment" value="Enviar Comentario" onclick="add_comment_img(\'' . $context['gallery_pic']['ID_PICTURE'] . '\'); return false;" tabindex="2" /></td></tr></table><div style="clear: left;"></div>
</form></div></div></div>
<!-- fin comentar --></div>';
}
...
echo '
	...
	<table border="0" width="80%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		...
		<tr class="windowbg">
			...
			<table>
				<tr><td>' . $txt['gallery_set_maxheight'] . '</td><td><input type="text" name="gallery_max_height" value="' .  $modSettings['gallery_max_height'] . '" /></td></tr>
				<tr><td>' . $txt['gallery_set_maxwidth'] . '</td><td><input type="text" name="gallery_max_width" value="' .  $modSettings['gallery_max_width'] . '" /></td></tr>
				<tr><td>' . $txt['gallery_set_filesize'] . '</td><td><input type="text" name="gallery_max_filesize" value="' .  $modSettings['gallery_max_filesize'] . '" /> (bytes)</td></tr>
				<tr><td>' . $txt['gallery_set_path'] . '</td><td><input type="text" name="gallery_path" value="' .  $modSettings['gallery_path'] . '" size="50" /></td></tr>
				<tr><td>' . $txt['gallery_set_url'] . '</td><td><input type="text" name="gallery_url" value="' .  $modSettings['gallery_url'] . '" size="50" /></td></tr>
			</table>
