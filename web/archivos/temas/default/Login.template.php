  ...
  if (!$context['login_error']) {
    echo '
      <table align="center">
        <tr align="center">
          <td align="center">
            <form action="' . $boardurl . '/conectandose/" method="post" accept-charset="' . $context['character_set'] . '" name="frmLogin" id="frmLogin"  onsubmit="hashLoginPassword(this, \'' . $context['session_id'] . '\');">
              <div class="ultimos_postsa" style="margin: 8px;">
                <div class="box_title" style="width: 378px;">
                  <div class="box_txt ultimos_posts" align="left">' . $txt[34] . '</div>
                  <div class="box_rss">
                    <img alt="" src="' . $settings['images_url'] . '/blank.gif" width="16px" />
                  </div>
                </div>
                    ...
                    <table width="100%">
                      <tr>
                        <td width="150px" style="text-align: right;">
                          <b class="size11">' . $txt[35] . ':</b>
                        </td>
                        <td width="150px" style="text-align: left;">
                          <input tabindex="1" size="30" maxlength="64" style="font-size: 10px; width: 150px;" id="user" name="user" class="ilogin" type="text" onfocus="foco(this);" onblur="no_foco(this);" />
                        </td>
                      </tr>
                      <tr>
                        <td width="150px" style="text-align: right;">
                          <b class="size11">' . $txt[36] . ':</b>
                        </td>
                        <td width="150px" style="text-align: left;">
                          <input tabindex="2" size="30" maxlength="64" style="font-size: 10px; width: 150px;" id="passwrd" name="passwrd" class="ilogin" type="password" onfocus="foco(this);" onblur="no_foco(this);" />
                        </td>
                      </tr>
                    </table>
                    <br />
                    <input class="login" type="submit" value="' . $txt['login'] . '" title="' . $txt['login'] . '" style="width: 150px;" />
                    <div class="hrs"></div>
                    <a href="' . $boardurl . '/recuperar-pass/">
                      <b>' . $txt[315] . '</b>
                    </a>
                    <br />
                    ' . $txt['invited_register_question'] . '
                    <a href="' . $boardurl . '/registrarse/" style="font-weight: bold; color: rgb(255, 0, 0);">' . $txt['invited_register_res'] . '</a>
      ...
      <div align="center">
        <div class="box_errors">
          <div class="box_title" style="width: 388px">
            <div class="box_txt box_error" align="left">' . $txt[106] . '</div>
            <div class="box_rss">
          ...
          <div class="windowbg" style="width: 380px; padding: 4px;">
            ...
            ' . $context['login_error'] . '
            <br /><br />
            <input class="login" style="font-size: 11px;" type="submit" title="' . $txt['back'] . '" value="' . $txt['back'] . '" onclick="location.href=\'' . $boardurl . '/ingresar/\'" />
            <input class="login" style="font-size: 11px;" type="submit" title="' . $txt['go_to_index_page'] . '" value="' . $txt['go_to_index_page'] . '" onclick="location.href=\'' . $boardurl . '/\'" />
            <br /><br />
          </div>
        </div>
        <br />
...
function template_maintenance() {
  ...
  echo '
    <form action="' . $boardurl . '/conectandose/" method="post" accept-charset="' . $context['character_set'] . '">
      <div>
        <div class="box_buscador">
          <div class="box_title" style="width: 920px;">
            <div class="box_txt box_buscadort">' . $context['title'] . '</div>
            <div class="box_rss">
              <img alt="" src="' . $settings['images_url'] . '/blank.gif" style="width: 14px; height: 12px;" border="0" />
            </div>
          </div>
          <div style="width: 912px; padding: 4px;" class="windowbg" border="0">
            ' . $context['description'] . '
            <br /><br />
          </div>
        </div>
        <div class="box_buscador">
          <div class="box_title" style="width: 920px;">
            <div class="box_txt box_buscadort">Iniciar sesi&oacute;n como Administrador</div>
            <div class="box_rss">
              <img alt="" src="' . $settings['images_url'] . '/blank.gif" style="width: 14px; height: 12px;" border="0" />
            </div>
          </div>
          <div style="width: 912px; padding: 4px; text-align: left;" class="windowbg" border="0">
            <font class="size12">
              <table border="0" width="90%" align="center">
                ...
                <tr>
                  <td align="center" colspan="4">
                    <input type="submit" value="' . $txt[34] . '" class="login" />
                  </td>
                </tr>
              </table>
              <br /><br />
            ...
            <div class="ultimos_postsa" style="margin: 8px;">
              ...
              <div class="windowbg" style="width: 370px; padding:4px;">
                <center>
                  ...
                  <br />
                  <input class="login" type="submit" value="' . $txt[34] . '" title="' . $txt[34] . '" style="width: 150px;" />
                  ' . $context['post_data'] . '
...
function template_retry_activate() {
  ...
  echo '
        ...
        <tr class="windowbg">
          <td colspan="2" align="center" style="padding: 1ex;">
