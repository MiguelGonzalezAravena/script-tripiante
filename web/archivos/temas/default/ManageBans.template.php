...
echo '<div class="box_title" style="width:740px;"><div class="box_txt">Lista</div></div>
<form action="', $scripturl, '?action=ban;sa=list" method="post" accept-charset="', $context['character_set'], '" onsubmit="return confirm(\'', $txt['ban_remove_selected_confirm'], '\');">
    <table border="0" cellspacing="1" cellpadding="4" class="windowbg" width="742">
    <tr>';
  ...
  while ($ban = $context['get_ban']())
  {
    echo '
      <tr>
        <td align="left" valign="top">', $ban['name'], '</td>
        <td align="left" valign="top">', $ban['notes'], '</td>
        <td align="left" valign="top">', $ban['reason'], '</td>
        <td align="left" valign="top">', $ban['added'], '</td>
        <td align="left" valign="top">', $ban['expires'], '</td>
        <td align="center" valign="top">', $ban['num_entries'], '</td>
        <td align="center" valign="top">
          &nbsp;<a href="', $scripturl, '?action=ban;sa=edit;sort=', $context['sort_by'], $context['sort_direction'] == 'up' ? ';desc' : '',';bg=', $ban['id'], '">', $txt[17], '</a>
        </td>
        <td align="center" valign="top"><input type="checkbox" name="remove[]" value="', $ban['id'], '" class="check" /></td>
      </tr>';
  }
  echo '
      <tr class="catbg3">
        <td colspan="8" align="left">
          <div style="float: right;">
            <input type="submit" name="removeBans" class="login" value="', $txt['ban_remove_selected'], '" />
          </div>
        </td>
      </tr>
    </table>
