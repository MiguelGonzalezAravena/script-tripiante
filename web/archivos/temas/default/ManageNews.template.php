...
function template_edit_news()
{
	...
	echo '
		<form action="', $boardurl, '/noticias/editar/" method="post" accept-charset="', $context['character_set'], '" name="postmodify" id="postmodify">
...
function template_email_members()
{
	...
	echo '
		<form action="', $boardurl, '/noticias/correo-componer/" method="post" accept-charset="', $context['character_set'], '">
...
function template_email_members_compose()
{
	...
	echo '
		<form action="', $boardurl, '/noticias/enviar-correo/" method="post" accept-charset="', $context['character_set'], '">
...
function template_email_members_send()
{
	...
	echo '
		<form action="', $boardurl, '/noticias/enviar-correo/" method="post" accept-charset="', $context['character_set'], '" name="autoSubmit" id="autoSubmit">
			<table width="600" cellpadding="4" cellspacing="0" border="0" align="center" class="tborder">
				<tr>
...
function template_news_settings()
{
	...
	echo '
	<form action="', $boardurl, '/noticias/configuracion" method="post" accept-charset="', $context['character_set'], '">
	...
	echo '
			<tr class="windowbg2">
				<td width="50%" align="right"><label for="xmlnews_enable_check">', $txt['xmlnews_enable'], '</label></td>
				<td>
