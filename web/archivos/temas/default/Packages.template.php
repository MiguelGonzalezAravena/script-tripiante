...
function template_view_package() {
    ...
    echo $txt['package44'] . '
      <table border="0" cellpadding="3" cellspacing="0" width="100%" style="margin-top: 1ex;">
        <tr>
          ...
          <td width="50%">
            <b>' . $txt['package_install_action'] . '</b>
          </td>
          <td width="20%">
            <b>' . $txt['package_install_desc'] . '</b>
          </td>
        </tr>';
  ...
  // If we need ftp information then demand it!
    ...
    if (!empty($context['package_ftp']['error'])) {
      echo '
          <div class="bordercolor" style="padding: 1px; margin: 1ex;">
