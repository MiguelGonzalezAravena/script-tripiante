...
<div align="left" style="margin-bottom:4px;"><span style="margin-bottom:5px;" class="icons cuenta2"><a href="/editar-perfil/">Editar mi perfil</a></span></div><div class="hrs"></div><span class="size10" style="font-family:arial;"><img src="' . $settings['images_url'] . '/user.gif" alt="" /> <b>Editar mi apariencia:</b><br/>
 <ul style="margin:0px;padding-left:15px;"><li style="margin:0px;padding-left:0px;"><a href="/editar-apariencia/paso1/">Formaci&oacute;n y trabajo</a></li>

<li style="margin:0px;padding-left:0px;"><a href="/editar-apariencia/paso2/">M&aacute;s sobre mi</a></li>
<li style="margin:0px;padding-left:0px;"><a href="/editar-apariencia/paso3/">Como soy</a></li>
<li style="margin:0px;padding-left:0px;"><a href="/editar-apariencia/paso4/">Intereses y preferencias</a></li></ul></span><div class="hrs"></div><div align="left" style="margin-bottom:4px;"><span class="icons mavatar"><a href="/editar-perfil/avatar/">Modificar mi avatar</a></span></div><div align="left" style="margin-bottom:4px;"><span class="icons aimg"><a href="/imagenes/agregar/">Agregar imagen</a></span></div><div align="left" style="margin-bottom:4px;"><span style="padding-left:2px;"><img alt="" src="' . $settings['images_url'] . '/icons/notas.gif" /> <a href="/mis-notas/">Mis notas</a></span></div></div></div>';
}
...
echo '<div class="userOption"><ul>';
	...
	echo '<li><a href="/editar-perfil/" title="Editar mi perfil">Editar mi perfil</a></li>';
	} else {
	echo '<li><a href="/mensajes/a/', $context['member']['name'], '" title="Enviarle mensaje privado">Enviarle mensaje privado</a></li>

<li><a class="profile_actions" href="/imagenes/', $context['member']['name'], '" title="Ver sus im&aacute;genes">Ver sus im&aacute;genes</a></li>
...
echo '<li><a href="/amigos-eliminar/', $context['member']['name'], '" title="Quitar amistad">Quitar amistad</a></li>';
}

echo '
<li><a class="profile_actions" href="/denunciar-usuario/', $context['member']['name'], '" title="Denunciar usuario">Denunciar usuario</a></li>
';
...
<li id="ac_no3" style="display:none;"><a href="#" onclick="ignorar(\'', $context['member']['name'], '\'); return false;" title="No ignorar usuario">No ignorar usuario</a></li>

<li id="ac_no2" style="display:none;"><a href="#" onclick="ignorar2(\'', $context['member']['name'], '\'); return false;" title="Ignorar usuario">Ignorar usuario</a></li>';
} else {
echo '<li id="ac_no"><a href="#" onclick="ignorar(\'', $context['member']['name'], '\'); return false;" title="No ignorar usuario">No ignorar usuario</a></li>
...
if($context['user']['is_logged']) {
echo '</div><div id="gif_cargando_ign" style="display:none;"><p align="right" style="padding:0px;margin:0px;"><img alt="" src="' . $settings['images_url'] . '/icons/cargando.gif" style="width:16px;height:16px;" border="0"  /></p><div style="clear: both;"></div></div>';
}

echo '<div style="margin-bottom:10px;margin-top:8px;">
<div class="box_title" style="width:160px;"><div class="box_txt box_perfil-36">Datos</div>
...
<p class="datosp">Nick:</p><a href="/perfil/', $context['member']['name'], '" title="', $context['member']['name'], '">', $context['member']['name'], '</a><br /><br /><p class="datosp">Es usuario desde:</p>', $context['member']['registered'], '<br /><br /><p class="datosp">Edad:</p>', $context['member']['age'], '<br /><br /><p class="datosp">Ciudad:</p>', $context['member']['location'], '<br /><br /><p class="datosp">Sexo:</p>', $context['member']['gender']['name'], ' - ', $context['member']['gender']['image'], '<br /><br /><p class="datosp">Pa&iacute;s:</p>', ssi_pais($context['member']['title']), ' - <img alt="" title="', ssi_pais($context['member']['title']), '" src="' . $settings['images_url'] . '/icons/banderas/', $context['member']['title'], '.gif" />';
if(!empty($context['member']['msn']['name'])) {
echo '<br /><br /><p class="datosp">Mensajero:</p>', $context['member']['msn']['name'];
}
if(!empty($context['member']['website']['title'])) {
echo '<br /><br /><p class="datosp">Sitio web:</p><a style="text-transform:lowercase;" href="', $context['member']['website']['title'], '" target="_blank">', $context['member']['website']['title'], '</a>';
}
if(!empty($context['member']['blurb'])) {
echo '<br /><br /><p class="datosp">Mensaje personal:</p>', $context['member']['blurb'];
}
echo '<br /><br /><p class="datosp">Rango:</p>', (!empty($context['member']['group']) ? $context['member']['group'] : $context['member']['post_group']), ' - ' . $context['member']['group_stars'] . '';
if(!empty($context['member']['estado_icon'])) {
echo '<br /><br /><p class="datosp">Estado:</p>'. ssi_estado_icon($context['member']['estado_icon']), ' - <img title="'. ssi_estado_icon($context['member']['estado_icon']), '" src="' . $settings['images_url'] . '/icons/estado/'. $context['member']['estado_icon'], '.gif" alt="" />';
}
echo '</div></div>';
}
...
<div class="box_title" style="width:160px;"><div class="box_txt box_perfil-36">Amigos en com&uacute;n</div>
<div class="box_rss"><img alt="" src="' . $settings['images_url'] . '/blank.gif" style="width:16px;height:16px;" border="0" /></div></div>
<div class="windowbg" style="width:152px;padding:4px;"><div style="float:left;font-size:10px;"><p style="margin:0px;padding:0px;"><a href="/perfil/', $context['member']['name'], '/amigos-en-comun/" title="' . $count1 . ' amigos en com&uacute;n">' . $count1 . ' amigos en com&uacute;n</a></p></div><div style="font-size:10px;"><p align="right" style="margin:0px;padding:0px;"><a href="/perfil/', $context['member']['name'], '/lista-de-amigos/" title="Ver todos">Ver todos</a></p></div><hr /><center><table><tr>';
}
foreach ($context['member']['buddies_data2'] as $buddy_id => $data) {
echo '
<td align="center" style="font-size:11px;font-family:arial;margin:0px;padding:0px;"><a href="/perfil/', $data['memberName'], '" title="', $data['realName'], '" style="text-decoration:none;"><img style="width:40px;height:40px;" alt="" src="';
if(!empty($data['avatar'])) {
echo $data['avatar'];
} else {
echo $boardurl . '/avatar.gif';
}
echo '" onerror="error_avatar(this)" /><br />', reducir_amigos($data['realName']), '</td>';
$count2++;
if($count2 == 3) {
echo '</tr><tr>';
}
...
<div class="box_title" style="width:160px;"><div class="box_txt box_perfil-36">Amigos</div>
<div class="box_rss"><img alt="" src="' . $settings['images_url'] . '/blank.gif" style="width:16px;height:16px;" border="0" /></div></div>
<div class="windowbg" style="width:152px;padding:4px;"><div style="float:left;font-size:10px;"><p style="margin:0px;padding:0px;"><a href="/perfil/', $context['member']['name'], '/lista-de-amigos/" title="' . $count3 . ' amigos">' . $count3 . ' amigos</a></p></div><div style="font-size:10px;"><p align="right" style="margin:0px;padding:0px;"><a href="/perfil/', $context['member']['name'], '/lista-de-amigos/" title="Ver todos">Ver todos</a></p></div><hr /><center><table><tr>';
}
...
<div class="box_rss"><img alt="" src="' . $settings['images_url'] . '/blank.gif" style="width:16px;height:16px;" border="0" /></div></div>
<div class="windowbg" style="width:152px;padding:4px;"><p class="datosp">Post:</p><a href="/user-post/', $context['member']['name'], '">', $context['member']['posts'], '</a><br /><br /><p class="datosp">Mensajes en su muro:</p><span id="cantmuro">', $context['muromsg'], '</span><br /><br /><p class="datosp">Comentarios:</p><a href="/user-comment/', $context['member']['name'], '">', $context['comentuser'] + $context['comentimguser'], '</a><br /><br /><p class="datosp">Im&aacute;genes:</p><a href="/imagenes/', $context['member']['name'], '">', $context['imguser'], '</a><br /><br /><p class="datosp">Puntos:</p>', $context['member']['moneyBank'], '</div></div></div>';
}
...
<div class="box_icono4"><img alt="" title="', $post['name'], '" src="', $settings['images_url'], '/post/icono_', $post['ID_BOARD'], '.gif" /></div><a href="/post/', $post['ID_TOPIC'], '/', $post['description'], '/', ssi_amigable($post['subject']), '.html">', ssi_reducir2(htmlentities($post['subject'], ENT_QUOTES, "UTF-8")), '</a></td></tr></table>';
}
echo '<br /><span style="font-size:9px;"><center><a href="/user-post/', $context['member']['name'], '">ver m&aacute;s</a></center></span>';
}
echo '</div></div>';
}
...
echo '<div style="margin-bottom:10px;">
<div class="box_title" style="width:201px;"><div class="box_txt box_perfil2-36">Panel de moderaci&oacute;n</div><div class="box_rss"><img alt="" src="' . $settings['images_url'] . '/blank.gif" style="width: 14px; height: 12px;" border="0" /></div></div>
<div class="windowbg" style="width:193px;padding:4px;">';
echo '<center><a href="/ban-user/', $context['member']['id'], '">Banear a ', $context['member']['name'], '</a></center>';
echo '<center><a href="/ver-ip/', $context['member']['ip'], '">Rastrear IP de ', $context['member']['name'], '</a></center>';
echo '<center><a href="/editar-usuario/', $context['member']['name'], '">Editar perfil de ', $context['member']['name'], '</a></center>';
echo '<center><a href="/mensajes/a/', $context['member']['name'], '">Enviar MP a ', $context['member']['name'], '</a></center>';
echo '<center><a href="/rastrear-user/', $context['member']['name'], '">Rastrear a ', $context['member']['name'], '</a></center>';
echo '</div></div>';
}
echo '
...
<td><input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="name" size="30" value="' . $context['member']['nombre'] . '" />
</td></tr>';
...
<option '; if($context['member']['birth_date']['year'] == '1947') { echo 'selected="selected" '; } echo 'value="1947">1947</option>
...
<option '; if($context['member']['birth_date']['year'] == '1944') { echo 'selected="selected" '; } echo 'value="1944">1944</option>
...
<input type="hidden" name="sa" value="', $context['menu_item_selected'], '" /></td></tr></table></div></div></form><div style="clear:both"></div>';
}
...
echo '<div class="box_780" style="float:left;margin-bottom:8px;"><div class="box_title" style="width: 778px;"><div class="box_txt box_780-34"><center>Formaci&oacute;n y trabajo</center></div><div class="box_rss"><img alt="" src="' . $settings['images_url'] . '/blank.gif" style="width:16px;height:16px;" border="0" /></div></div><div class="windowbg" border="0" style="width: 770px; padding: 4px;"><form action="/accion-apariencia/paso1/" method="post" accept-charset="', $context['character_set'], '" enctype="multipart/form-data" style="margin:0px;padding:0px;"><table cellpadding="4" width="100%"><tbody><tr><td align="right" valign="top" width="23%"><b>Estudios:</b></td><td width="40%"><select id="estudios" name="estudios"><option '; if(empty($context['member']['estudios'])) { echo 'selected="selected"'; } echo 'value="">Sin Respuesta</option><option '; if($context['member']['estudios'] == 'sin') { echo 'selected="selected"'; } echo 'value="sin">Sin Estudios</option><option '; if($context['member']['estudios'] == 'pri') { echo 'selected="selected"'; } echo 'value="pri">Primario completo</option><option '; if($context['member']['estudios'] == 'sec_curso') { echo 'selected="selected"'; } echo 'value="sec_curso">Secundario en curso</option><option '; if($context['member']['estudios'] == 'sec_completo') { echo 'selected="selected"'; } echo 'value="sec_completo">Secundario completo</option><option '; if($context['member']['estudios'] == 'ter_curso') { echo 'selected="selected"'; } echo 'value="ter_curso">Terciario en curso</option><option '; if($context['member']['estudios'] == 'ter_completo') { echo 'selected="selected"'; } echo 'value="ter_completo">Terciario completo</option><option '; if($context['member']['estudios'] == 'univ_curso') { echo 'selected="selected"'; } echo 'value="univ_curso">Universitario en curso</option><option '; if($context['member']['estudios'] == 'univ_completo') { echo 'selected="selected"'; } echo 'value="univ_completo">Universitario completo</option><option '; if($context['member']['estudios'] == 'post_curso') { echo 'selected="selected"'; } echo 'value="post_curso">Post-grado en curso</option><option '; if($context['member']['estudios'] == 'post_completo') { echo 'selected="selected"'; } echo 'value="post_completo">Post-grado completo</option></select></td></tr><tr><td align="right" valign="top" width="23%"><b>Profesi&oacute;n:</b></td><td width="40%"><input size="30" maxlength="32" name="profesion" id="profesion" value="', $context['member']['profesion'], '" type="text" onfocus="foco(this);" onblur="no_foco(this);" /></td></tr><tr><td align="right" valign="top"><b>Empresa:</b></td><td><input size="30" maxlength="32" name="empresa" id="empresa" value="', $context['member']['empresa'], '" type="text" onfocus="foco(this);" onblur="no_foco(this);" /></td></tr><tr><td align="right" valign="top"><b>Nivel de ingresos:</b></td><td><select id="ingresos" name="ingresos"><option '; if(empty($context['member']['ingresos'])) { echo 'selected="selected"'; } echo ' value="">Sin Respuesta</option><option '; if($context['member']['ingresos'] == 'sin') { echo 'selected="selected"'; } echo 'value="sin">Sin ingresos</option><option '; if($context['member']['ingresos'] == 'bajos') { echo 'selected="selected"'; } echo 'value="bajos">Bajos</option><option '; if($context['member']['ingresos'] == 'intermedios') { echo 'selected="selected"'; } echo 'value="intermedios">Intermedios</option><option '; if($context['member']['ingresos'] == 'altos') { echo 'selected="selected"'; } echo 'value="altos">Altos</option></select></td></tr><tr><td align="right" valign="top"><b>Intereses Profesionales:</b></td><td><textarea name="intereses_profesionales" cols="30" rows="5" id="intereses_profesionales">', $context['member']['intereses_profesionales'], '</textarea></td></tr><tr><td align="right" valign="top"><b>Habilidades Profesionales:</b></td><td><textarea name="habilidades_profesionales" cols="30" rows="5" id="habilidades_profesionales">', $context['member']['habilidades_profesionales'], '</textarea></td></tr><tr><td colspan="3" align="center"><hr>Al modificar mi apariencia tambi&eacute;n acepto los <a href="/terminos-y-condiciones/" target="_blank">T&eacute;rminos de uso</a>.</td></tr><tr><td colspan="3" align="center"><input class="button" style="font-size: 15px;" value="Modificar mi apariencia" title="Modificar mi apariencia" type="submit" /><input type="hidden" name="sc" value="', $context['session_id'], '" /><input type="hidden" name="userID" value="', $context['member']['id'], '" /><input type="hidden" name="sa" value="', $context['menu_item_selected'], '" /></td></tr></tbody></table></form></div></div><div style="clear:both"></div>';
}
...
{
	global $context, $settings, $options, $txt, $notes, $scripturl, $ID_MEMBER, $modSettings;
...
<a href="/perfil/', $context['member']['name'], '/muro/" title="Muro" alt="Muro"><img src="' . $settings['images_url'] . '/icons/muro.gif" alt="Muro" title="Muro" /> Muro</a></li>
<li>

<a href="/perfil/', $context['member']['name'], '/apariencia/" title="Apariencia" alt="Apariencia"><img src="' . $settings['images_url'] . '/user.gif" alt="Apariencia" title="Apariencia"/> Apariencia</a>
</li>
<li>

<a href="/perfil/', $context['member']['name'], '/comunidades/" title="Comunidades" alt="Comunidades"><img src="' . $settings['images_url'] . '/comunidades/comunidad.png" alt="Comunidades" title="Comunidades" /> Comunidades</a>
</li>
...
<div class="windowbg" style="font-size:11px;width:523px;padding:8px;"><center>'; if($context['member']['estado_icon'] == 'mcontento') { echo '<u><b>'; } echo'<a href="/estado/mcontento/" title="Muy contento/a">Muy contento/a</a>'; if($context['member']['estado_icon'] == 'mcontento') { echo '</u></b>'; } echo' - '; if($context['member']['estado_icon'] == 'contento') { echo '<u><b>'; } echo '<a href="/estado/contento/" title="Contento/a">Contento/a</a>'; if($context['member']['estado_icon'] == 'contento') { echo '</u></b>'; } echo ' - '; if($context['member']['estado_icon'] == 'sueno') { echo '<u><b>'; } echo '<a href="/estado/cons/" title="Con sue&ntilde;o">Con sue&ntilde;o</a>'; if($context['member']['estado_icon'] == 'sueno') { echo '</u></b>'; } echo ' - '; if($context['member']['estado_icon'] == 'descansar') { echo '<u><b>'; } echo '<a href="/estado/desc/" title="Descansando">Descansando</a>'; if($context['member']['estado_icon'] == 'descansar') { echo '</u></b>'; } echo ' - '; if($context['member']['estado_icon'] == 'triste') { echo '<u><b>'; } echo '<a href="/estado/triste/" title="Triste">Triste</a>'; if($context['member']['estado_icon'] == 'triste') { echo '</u></b>'; } echo ' - '; if($context['member']['estado_icon'] == 'enferm') { echo '<u><b>'; } echo '<a href="/estado/enferm/" title="Enfermo/a">Enfermo/a</a>'; if($context['member']['estado_icon'] == 'enferm') { echo '</u></b>'; } echo ' - '; if($context['member']['estado_icon'] == 'emusic') { echo '<u><b>'; } echo '<a href="/estado/emusic/" title="Escuchando m&uacute;sica">Escuchando m&uacute;sica</a>'; if($context['member']['estado_icon'] == 'emusic') { echo '</u></b>'; } echo '<br />'; if($context['member']['estado_icon'] == '') { echo '<u><b>'; } echo '<a href="/estado/qestado/" title="Sin estado">Sin estado</a>'; if($context['member']['estado_icon'] == '') { echo '</u></b>'; } echo '</center></div></div>';
...
echo '<div style="clear: left;"><div class="noesta-am" style="width:541px;margin-bottom:8px;">Para poder comentar en este muro es necesario estar <a href="/registrarse/" style="color:#FFB600;" title="Reg&iacute;strarse">Registrado</a>.<br/>Si ya tienes usuario <a href="/ingresar/" style="color:#FFB600;" title="Conectarse">&iexcl;Con&eacute;ctate!</a></div></div>';
}
...
{
	global $settings, $db_prefix, $context, $modSettings;
...
<td style="text-align:left;"><a href="/post/' . $row['ID_TOPIC'] . '/' . $row['description'] . '/' . ssi_amigable($row['subject']) . '.html" title="" title="' . $row['subject'] . '">' . $row['subject'] . '</a></td>
...
<li>
<a href="/user-comment/', $context['member']['name'], '" title="Comentarios en posts">Comentarios en posts (' . $count_c . ')</a></li>
<li>

<a href="/user-comment-img/', $context['member']['name'], '" title="Comentarios en im&aacute;genes">Comentarios en im&aacute;genes (' . $count_c_img . ')</a>
</li>
...
{
	global $db_prefix, $ID_MEMBER, $context, $user_profile, $memberContext, $txt, $settings, $scripturl, $modSettings;
...
if($context['member']['name'] == $context['user']['name'] || $context['allow_admin']) {
echo '<a onclick="if (!confirm(\'\xbfEstas seguro que deseas eliminar a este usuario de tus amigos?\')) return false;" href="/amigos-eliminar/', $row['memberName'], '/" title="Eliminar usuario de mi lista de amigos"><img alt="Eliminar usuario de mi lista de amigos" src="', $settings['images_url'], '/eliminar.gif" width="8px" height="8px"></a>&#32;-&#32;';
}
echo '<b><span style="font-size: 12px;"><a href="/perfil/', $row['memberName'], '" title="', $row['realName'], '">', $row['realName'], '</a></span></b>';
