      ...
      <div class="box_buscador">
        <div class="box_title" style="width: 920px;">
          <div class="box_txt box_buscadort">
            <center>Recomendar ' . $context['forum_name'] . ' a tus amigos</center>
          </div>
          <div class="box_rss">
        ...
        <div style="width: 912px; padding: 4px;" class="windowbg">
          <center>
            <form action="' . $boardurl . '/recomendando/" method="post" accept-charset="' . $context['character_set'] . '">
              <br />
              <font class="size11">
                <b>Recomendar ' . $context['forum_name'] . ' hasta a seis amigos:</b>
              </font>
              <br />
              <b class="size11">1 - </b>
              ...
              <br /><br />
              <font class="size11"><b>Asunto:</b></font>
              <br />
              <input size="40" name="titulo" value="Te recomiendo ' . $context['forum_name'] . '" type="text" onfocus="foco(this);" onblur="no_foco(this);">
              <br /><br />
              <font class="size11"><b>Mensaje:</b></font>
              <br />
              ...
              <br /><br />
              <font class="size11">
                <strong>C&oacute;digo de la im&aacute;gen:</strong>
              </font>
              <br />
              ...
              <br /><br />
              <input onclick="return showr_email(this.form.comment.value);" type="submit" class="login" name="send" value="Recomendar ' . $context['forum_name'] . '" />
            </form>
          </center>
        </div>
      </div>
