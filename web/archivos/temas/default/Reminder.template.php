		...
		<div align="center">
			<form action="' . $boardurl . '/recuperar-pass/enviando/" method="post" accept-charset="' . $context['character_set'] . '">
				<div class="box_title" style="width: 363px;">
					<div class="box_txt box_363-34">' . $txt[194] . ' </div>
					<div class="box_rss">
						<div class="icon_img">
							<img src="' . $settings['images_url'] . '/blank.gif?v3.2.3">
						</div>
					</div>
				</div>
				<table border="0" width="363" cellspacing="0" cellpadding="4" class="windowbg">
					...
					<tr align="left">
						<td width="40%" align="center">
							<b class="size11">' . $txt['smf100'] . ':</b><br />
		...
		<form action="' . $scripturl . '?action=reminder;sa=secret2" method="post" accept-charset="' . $context['character_set'] . '">
			<table border="0" width="440" cellspacing="0" cellpadding="4" class="tborder" align="center">
				...
				<tr class="windowbg2">
					...
					<td>
						<input type="text" name="secretAnswer" size="22" />
					</td>
				</tr>
				<tr class="windowbg2">
					<td width="45%">
				...
				<tr class="windowbg2">
					<td colspan="2" align="right" style="padding: 1ex;">
						<input type="submit" value="' . $txt[10] . '" />
					</td>
				</tr>
			</table>
