    ...
    <div>
      <div class="box_buscador">
        ...
        <div style="width: 911px; padding: 4px;" class="windowbg">
          <center>
            <form action="' . $boardurl . '/enviar-a-amigo/enviando-img/' . $id . '" method="post" accept-charset="' . $context['character_set'] . '">
              <br />
              <font class="size11">
              ...
              <b class="size11">2 - </b><input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="r_email1" size="28" maxlength="60" />
              <br />
              <b class="size11">3 - </b>
              ...
              <noscript>
                ...
                <br />
                <textarea name="recaptcha_challenge_field" rows="2" cols="10"></textarea><input type="hidden" name="recaptcha_response_field" value="manual_challenge" />
              </noscript>
              <br />
              <input onclick="return showr_email(this.form.comment.value);" type="submit" class="login" name="send" value="Recomendar imagen" />
              <br />
              <a href="' . $boardurl . '/imagenes/ver/' . $id . '" title="&#171; Volver a la imagen" target="_self">&#171; Volver al post</a>
            </form>
          </center>
        </div>
      </div>
