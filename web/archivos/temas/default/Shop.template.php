...
<table align="center" width="392px" cellpadding="3" cellspacing="0" border="0">	
       ...
       ', $context['shop_buy_message'], '
		<br>
		<br>
	    <input class="login" style="font-size: 11px;" type="submit" title="Volver al post" value="Volver al post" onclick="location.href=\'?topic='.$_GET['topic'].'\'" /> <input class="login" style="font-size: 11px;" type="submit" title="Ir a la P&aacute;gina principal" value="Ir a la P&aacute;gina principal" onclick="location.href=\'/\'" />
        <br>
        <br>
		</td>
		</tr>
