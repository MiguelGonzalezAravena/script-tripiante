    ...
    <div class="box_buscador">
      <div class="box_title" style="width: 920px;">
        <div class="box_txt box_buscadort">
          <center>' . $txt['smftags_popular'] . '</center>
        </div>
        <div class="box_rss">
          <img alt="" src="/images/blank.gif" style="width: 14px; height: 12px;" border="0" />
        </div>
      </div>
      <div style="width: 912px; padding: 4px;" class="windowbg">
        <center>En esta nube se reflejan los 100 tags m&aacute;s populares. Cuanto m&aacute;s grande es la palabra, mayor cantidad de veces fue utilizada.<br />
        ordenar: <a href="' . $boardurl . '/tags-alfa/" title="alfab&eacute;ticamente">alfab&eacute;ticamente</a> | <a href="' . $boardurl . '/tags-importancia/" title="por importancia">por importancia</a>
        <hr />';
      ...
      <table border="1" cellpadding="0" cellspacing="0" align="center" width="50%">
        ...
        <tr>
          <td width="28%"  class="windowbg2" align="right">
            <span class="gen"><b>' . $txt['smftags_tagtoadd'] . '</b></span>
          </td>
        ...
        <tr>
          <td width="28%" colspan="2" align="center" class="windowbg2">
            ...
            <input type="submit" value="' . $txt['smftags_addtag2'] . '" name="submit" />
          </td>
        </tr>
      </table>
    </form>';
...
function template_admin_settings() {
        ...
        <td>
          ...
          <form method="post" action="' . $scripturl . '?action=tags;sa=admin2">
            <table border="0" width="100%" cellspacing="0" align="center" cellpadding="4">
              ...
              <tr>
                <td width="30%">' . $txt['smftags_set_cloud_tags_per_row'] . '</td>
  ...
  echo '
    <br />
    <div align="center">
      <span class="smalltext">Powered By <a href="http://www.smfhacks.com" target="blank">SMF Tags</a></span>
    </div>';
}
  ...
  echo '
    <form method="POST" action="' . $scripturl . '?action=tags;sa=suggest2">
      <table border="1" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          <td width="28%"  class="windowbg2" align="right">
            <span class="gen"><b>' . $txt['smftags_tagtosuggest'] . '</b></span>
          </td>
          <td width="72%" class="windowbg2">
            <input type="text" name="tag" size="64" maxlength="100" />
          </td>
        ...
        <tr>
          <td width="28%" colspan="2" align="center" class="windowbg2">
            <input type="submit" value="' . $txt['smftags_suggest'] . '" name="submit" />
          </td>
        </tr>
      </table>
    </form>';
